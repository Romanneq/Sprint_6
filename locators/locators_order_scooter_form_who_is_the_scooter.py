...
class LocatorsOrderPageWhoIsTheScooter:
    text_form_who_is_the_scooter_for = [By.XPATH,'.//div[text()="Для кого самокат"]'] # локатор текста формы "Для кого самокат?"
    ...
    button_go_to_rental_form = [By.XPATH, ".//button[@class='Button_Button__ra12g Button_Middle__1CSJM']"] # кнопка "Далее" в форме "Для кого самокат"
